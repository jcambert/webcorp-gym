!function (angular,gapi) {
    "use strict";
    var gallery=angular.module('angular.gallery', []);

    gallery.directive('ngGallery', ['$document', '$timeout', '$q', '$templateCache', function($document, $timeout, $q, $templateCache) {
        'use strict';
        ...
        '  <img src={{imageLoader}} ng-show="loading"/></div></div>' +
